...
- **반응형 그리드 레이아웃** - 모든 화면에서 완벽하게 확장되는 카드
- **일관된 카드 높이** - 콘텐츠 길이에 관계없이 균일한 레이아웃
...
- **태그 시스템** - 사용자 정의 태그로 정리 및 스마트 필터링
...
│   │   ├── LinkCard.tsx # 개별 북마크 카드
│   │   └── AddLinkModal.tsx # 링크 추가/편집 다이얼로그
│   ├── types/           # TypeScript 정의
│   ├── utils/           # 유틸리티 함수
│   └── styles/          # CSS 및 스타일링
│
...
### **컴포넌트**
- **카드**: 호버 효과가 있는 일관된 208px 높이
- **버튼**: 오렌지 기본, 고스트 보조, 파괴적 빨강
- **타이포그래피**: Inter 폰트 패밀리, 반응형 크기
